...
class SocketService {
  ...
  sendMessage(theaterId, message, imageUrl = null) {
    ...
    if (!this.socket.connected) {
      console.warn('⚠️ Admin Socket not connected, waiting for connection...');
  ...
  onNewMessage(callback) {
    if (this.socket) {
      ...
      console.log('Admin Socket: new_message listener registered');
    }
  }
  ...
  offNewMessage(callback) {
    if (this.socket) {
      ...
      console.log('Admin Socket: new_message listener removed');
    }
  }
}
