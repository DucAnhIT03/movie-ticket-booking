...
class SocketService {
  ...
  connect(token) {
    ...
    this.socket.on('connect', () => {
      ...
      console.log('✅ Socket connected (Staff)');
    ...
    this.socket.on('disconnect', () => {
      this.isConnected = false;
      console.log('❌ Socket disconnected (Staff)');
    });
    ...
    this.socket.on('reconnect', () => {
      this.isConnected = true;
      console.log('✅ Socket reconnected (Staff)');
  ...
  onNewMessage(callback) {
    if (this.socket) {
      ...
      console.log('Socket (Staff): new_message listener registered');
    }
  }
  ...
  offNewMessage(callback) {
    if (this.socket) {
      ...
      console.log('Socket (Staff): new_message listener removed');
    }
  }
}
