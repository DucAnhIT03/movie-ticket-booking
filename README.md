...
Notes:
- For production, set `TYPEORM_SYNC=false` and use migrations instead of `synchronize`.
- Make sure `JWT_SECRET` is a long, unguessable value.

After setting environment variables, install dependencies and run in dev mode:
